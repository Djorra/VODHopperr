...
<div class="container">
    ...
    <a href="<?= Http::asset('inloggen/index.php'); ?>">Heb je al een account? Klik hier om in te loggen </a>
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="first_name" class="form-control" value="La-Shawn" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="last_name" class="form-control" value="Pufflijk" required>
            </div>
        </div>
